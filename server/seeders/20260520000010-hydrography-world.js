...
module.exports = {
  up: async (queryInterface) => {
    ...
    const lakes = [
      ...
      { name: 'Mirror Lake',           x:  -5200, z:   7400, radius: 280, sides: 9,  variance: 0.35, seed: 5  },
      ...
      { name: 'Plains Pond',            x:   5200, z:  -4800, radius: 110, sides: 8,  variance: 0.30, seed: 20 },
      // Small ponds (radius 40–150)
      { name: 'Millpond',              x:  -6200, z:  -4500, radius: 90,  sides: 7,  variance: 0.40, seed: 21 },
      { name: 'Sheep Pool',            x:   6500, z:  -4800, radius: 70,  sides: 7,  variance: 0.35, seed: 22 },
    ...
    const rivers = [
      ...
      { name: 'Central Canal',      sx: -18000, sz:  14000, ex: -10000, ez: -14000, w: 22, seg: 5, spread:  700, seed: 43 },
      ...
      // Creeks (width 5–10)
      { name: 'Mill Creek',         sx:  -7000, sz:   6500, ex:  -4500, ez:   4000, w:  7, seg: 3, spread:  300, seed: 53 },
